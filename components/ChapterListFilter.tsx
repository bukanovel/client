      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1 sm:w-64">
            <span className="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-slate-400 dark:text-zinc-500 text-sm">
              search
            </span>
            <input
              type="text"
              ...
              >
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-semibold text-slate-800 dark:text-zinc-200 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors flex items-center gap-2">
                    {chapter.title}
                    {isLocked && (
                      <span className="material-symbols-outlined text-xs text-orange-600 dark:text-orange-500">
                        lock
                      </span>
                    )}
                  </span>
